...
public class UserProcess {
	...
	*/
	...
	for(int i = 0; i < argc; i++) {		
		aux = readVirtualMemoryString(position, 255);
		position = position + aux.length() + 1;	
		childParams[i] = aux;
	}
	...
	byte[] b = ByteBuffer.allocate(4).putInt(childStatus).array(); 		
